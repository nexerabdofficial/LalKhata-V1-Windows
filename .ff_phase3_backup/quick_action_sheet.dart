    ...
    await _showSheet(
      ...
      items: [
        _QuickSheetItem(
          ...
          title: 'Add Account',
          subtitle: 'Cash, Bank, MFS, Asset, Liability, Capital...',
          page: const AddAccountScreen(),
        ),
        _QuickSheetItem(
          icon: Icons.person_add_alt_1_outlined,
          title: 'Add Customer',
          subtitle: 'Create customer / receivable party',
          page: const AddCustomerScreen(),
        ),
        _QuickSheetItem(
          icon: Icons.local_shipping_outlined,
          title: 'Add Supplier',
          subtitle: 'Create supplier / payable party',
    ...
    await _showSheet(
      ...
      items: [
        ...
        _QuickSheetItem(
          ...
          title: 'Loan',
          subtitle: 'Give or take loan and track repayment',
          page: const AddLoanScreen(),
        ),
        _QuickSheetItem(
          icon: Icons.trending_up_rounded,
          title: 'Income',
          subtitle: 'Record other business income',
          page: const AddIncomeScreen(),
        ),
        _QuickSheetItem(
          icon: Icons.trending_down_rounded,
          title: 'Expense',
          subtitle: 'Record operating expense',
