...
class _SalesReportScreenState extends State<SalesReportScreen> {
  ...
  Future<void> _loadReport() async {
    ...
    switch (_filter) {
      ...
      case ReportFilter.thisWeek:
        ...
        from = now.subtract(Duration(days: daysSinceSaturday));
  ...
  double get totalSales {
    ...
    for (final sale in _sales) {
      total += (sale['grand_total'] as num).toDouble();
    }
                    ...
                    child: Row(
                      children: [
                        ChoiceChip(
                          ...
                          onSelected: (_) => _changeFilter(ReportFilter.today),
                        ),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(sale['sale_date']),
                        trailing: Text("৳${sale['grand_total']}"),
                      );
                    },
                  ),
                ),
