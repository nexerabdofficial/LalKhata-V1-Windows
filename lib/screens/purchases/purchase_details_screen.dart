...
import '../invoices/purchase_invoice_preview_screen.dart';
...
class _PurchaseDetailsScreenState extends State<PurchaseDetailsScreen> {
  ...
  Future<void> _loadPurchase() async {
    final purchaseFuture = _purchaseRepository.getPurchaseById(
      widget.purchaseId,
    );

    final itemsFuture = _purchaseItemRepository.getItemHistoryByPurchase(
      widget.purchaseId,
    );
  ...
  Future<void> _openInvoicePreview() async {
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PurchaseInvoicePreviewScreen(
          purchase: purchase,
          items: List<PurchaseItemHistory>.from(_items),
        ),
      ),
    );
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _isLoading || _purchase == null
                ? null
                : _openInvoicePreview,
          ),
          IconButton(
            ...
            onPressed: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => PurchaseScreen(purchaseId: widget.purchaseId),
                ),
              );
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Purchase Date: ${_purchase!.purchaseDate}'),
                  ...
                  ListTile(
                    ...
                    trailing: Text(_purchase!.grandTotal.toStringAsFixed(2)),
                  ),

                  ListTile(
                    title: const Text('Paid'),
                    trailing: Text(_purchase!.paid.toStringAsFixed(2)),
                  ),
