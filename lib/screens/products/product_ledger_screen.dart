...
class _ProductLedgerScreenState extends State<ProductLedgerScreen> {
  ...
  void _setDatePreset(String value) {
    ...
    switch (value) {
      ...
      case 'This Week':
        // Bangladesh business week starts on Saturday.
  ...
  int _getPreviousStock() {
    ...
    final startDate = _dateOnly(_fromDate!);
    ...
    for (final item in _ledger) {
      ...
      final transactionDate = _dateOnly(parsed);

      // Everything strictly BEFORE the selected period
      // becomes the brought-forward / previous stock.
